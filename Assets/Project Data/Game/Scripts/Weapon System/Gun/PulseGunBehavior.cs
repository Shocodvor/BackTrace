...
{
    public class PulseGunBehavior : BaseGunBehavior
    {
        [LineSpacer]
        ...
        private SMGUpgrade upgrade;

        public override void Initialise(CharacterBehaviour characterBehaviour, WeaponData data)
        {
            base.Initialise(characterBehaviour, data);

            upgrade = UpgradesController.GetUpgrade<SMGUpgrade>(data.UpgradeType);
            ...
            RecalculateDamage();
             ...
             characterBehaviour.speedWeaponChanger = 0.9f;
        }
