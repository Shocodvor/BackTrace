...
{
    public class PistolBehavior : BaseGunBehavior
    {
        [LineSpacer]
        ...
        private PistolUpgrade upgrade;

        public override void Initialise(CharacterBehaviour characterBehaviour, WeaponData data)
        {
            base.Initialise(characterBehaviour, data);

            upgrade = UpgradesController.GetUpgrade<PistolUpgrade>(data.UpgradeType);
            ...
            RecalculateDamage();
             ...
             characterBehaviour.speedWeaponChanger = 1.05f;
        }
