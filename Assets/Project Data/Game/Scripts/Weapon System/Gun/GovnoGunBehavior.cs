...
{
    public class GovnoGunBehavior : BaseGunBehavior
    {
        [LineSpacer]
        ...
        private GovnoGunUpgrade upgrade;
        ...
        public override void Initialise(CharacterBehaviour characterBehaviour, WeaponData data)
        {
            ...
            upgrade = UpgradesController.GetUpgrade<GovnoGunUpgrade>(data.UpgradeType);
            ...
            RecalculateDamage();
             ...
             characterBehaviour.speedWeaponChanger = 0.75f;
        }
