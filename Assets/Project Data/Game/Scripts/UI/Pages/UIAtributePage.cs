...
{
    public class UIAtributePage : UIPage
    { private const float SCROLL_SIDE_OFFSET = 50;
        ...
        private AtributeDatabase atributeDatabase;

        private AtributePanelUI[] characterPanels;
        ...
        {
            atributeDatabase = AtributeController.GetDatabase();
         ...
         //   characterPanels = new AtributePanelUI[charactersDatabase.Characters.Length];
    ...
    //    {
     ...
     //   }
        ...
        public AtributePanelUI GetPanel(AtributeType AtributeType)
        {
            for (int i = 0; i < characterPanels.Length; i++)
          {
        ...
        {
            UIController.HidePage<UIAtributePage>(() =>
            {
